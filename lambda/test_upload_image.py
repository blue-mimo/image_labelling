...
import base64
import os
from upload_image import lambda_handler, parse_multipart_data, get_file_name_and_data, HTTPClientError
...
class TestUploadImage(unittest.TestCase):
    ...
    def test_parse_multipart_data_malformed(self):
        ...
        result = parse_multipart_data(b'malformed', 'multipart/form-data; boundary=test')
        self.assertEqual(result, (None, None))
